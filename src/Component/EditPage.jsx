...
//  const { name, Capacity, image, price, description, category, floor } = rooms;
//   const CATEGORIES = [
//     "Whiteboard",
//     "Projector",
//     "Wifi",
...
export default async function EditPage({ rooms }) {
  const { _id, name, Capacity, image, price, description, category, floor } =
    rooms;

  // ✅ FIX: updateCourse call করা হচ্ছে, addCourse নয়
      ...
      <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-slate-200 shadow-2xl space-y-10">
        ...
        <form action={handleUpdateCourse} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* ✅ FIX: Category checkboxes <Select> এর বাইরে */}
